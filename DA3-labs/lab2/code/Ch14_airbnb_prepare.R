...
############################################################
# IN   airbnb_london_cleaned.csv
# OUT  airbnb_london_workfile.csv
#      airbnb_hackney_workfile.csv
#      airbnb_hackney_workfile_adj.csv
...
ggsave(paste0(output, "R_F14_h_lnprice.png"), width=mywidth_large, height=myheight_large, units = "cm", dpi = 1200)
...
ggsave(paste0(output, "R_F14_h_price.png"), width=mywidth_large, height=myheight_large, units = "cm", dpi = 1200)
...
ggsave(paste0(output, "R_14_s_n_accommodates.png"), width=mywidth_large, height=myheight_large, units = "cm", dpi = 1200)
