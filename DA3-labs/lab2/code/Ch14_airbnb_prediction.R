...
plot1
ggsave(paste0(output, "plot1_R.png"),plot = plot1, width=mywidth_large, height=myheight_large, units = "cm", dpi = 1200)
cairo_ps(filename = paste0(output, "plot1_R.eps"),
...
plot2
ggsave(paste0(output, "plot2_R.png"), plot = plot2, width=mywidth_large, height=myheight_large, units = "cm", dpi = 1200)
cairo_ps(filename = paste0(output, "plot2_R.eps"),
         width = mywidth_large, height = myheight_large, pointsize = 12,
         fallback_resolution = 1200)
print(plot2)
dev.off()
...
ggsave(paste(output,"ch14_priceplot1and2.png",sep=""))
cairo_ps(filename = paste0(output, "ch14_priceplot1and2.eps"),
         width = mywidth_large, height = myheight_large, pointsize = 12,
         fallback_resolution = 1200)
...
plot3 <- ggplot(datau, aes(x = factor(n_accommodates), y = price, fill = factor(f_property_type), color=factor(f_property_type))) +
  ...
  theme(legend.position = "bottom")
plot3
ggsave(paste0(output, "plot3_R.png"), plot = plot3, width=mywidth_large, height=myheight_large, units = "cm", dpi = 1200)
cairo_ps(filename = paste0(output, "plot3_R.eps"),
         width = mywidth_large, height = myheight_large, pointsize = 12,
         fallback_resolution = 1200)
print(plot3)
dev.off()
...
plot4 <- ggplot(data = datau, aes(x = factor(n_accommodates), color = f_room_type, fill = f_room_type)) +
  ...
  theme(legend.position = "bottom")
plot4
ggsave(paste0(output, "plot4_R.png"), plot = plot4, width=mywidth_large, height=myheight_large, units = "cm", dpi = 1200)
cairo_ps(filename = paste0(output, "plot4_R.eps"),
         width = mywidth_large, height = myheight_large, pointsize = 12,
         fallback_resolution = 1200)
print(plot4)
dev.off()
...
ggsave(paste(output,"ch14_priceplot3and4.png",sep=""))
cairo_ps(filename = paste0(output, "ch14_priceplot3and4.eps"),
         width = mywidth_large, height = myheight_large, pointsize = 12,
         fallback_resolution = 1200)
