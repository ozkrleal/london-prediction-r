...
data<-read.csv("bristol/listings.csv.gz")
...
saveRDS(data, file="airbnb_bristol_listing.rds")
#write.csv(data,file="airbnb_london_listing.csv")

#####################################
#opening dfset
df<-readRDS("airbnb_bristol_listing.rds")
...
saveRDS(df,file="airbnb_bristol_cleaned.rds")
